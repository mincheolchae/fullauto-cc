...
# /vibe-enhance — Project-fit / Convention / Trend-based Proactive Enhancement
...
LARGE additions (`[ENHANCE:L]` or multi-file FIT-BREAK) take more user
attention than small ones, so report them in a **dedicated, prominent
section**. Bundle small additions into a single list.
...
**OPTIONAL (사용자 판단용, n개):**
- <한 줄 설명>     ← omit this whole section if there are none

**트렌드 노트 (참고만, n개):**
- <한 줄> · <source URL>     ← omit this whole section if there are none
